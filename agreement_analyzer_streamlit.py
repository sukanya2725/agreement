...
import os
import re
import textwrap  # ✅ Required for formatting
...
if uploaded_file:
    ...
    title = textwrap.fill(title, 100) if title else "Not specified"
